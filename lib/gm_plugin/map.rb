  ...
  module GmPlugin 
    ...
    class GMap
      ...
      def control_init(controls = {})
        ...
        event_init(self, :click, controls[:click_map]) if controls[:click_map]
